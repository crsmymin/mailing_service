	           ...
	           <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <label class="form-control-label" style="margin: 8px 0;">총 청구금액 (건)</label>
                            </div>
                                ...
                                <table id="bootstrap-data-table-export-searchfalse" class="table table-striped table-bordered">
                                    ...
                                    <tbody id="table_list">
										<tr>
											...
											<td><a href="/bill_wechat_view?view_id=2">미샤 <i class="menu-icon fa  fa-search"></i></a></td>
										...
										<tr>
											<td class='text-align-center'>2020/02</td>
											<td class='text-align-center'>2020/01/01~2020/01/31</td>
											<td><a href="/bill_wechat_view?view_id=2">지노다노 <i class="menu-icon fa  fa-search"></i></a></td>
											<td class='text-align-center'>800,000</td>
											<td class='text-align-center'>0</td>
											<td class='text-align-center'>800,000</td>
