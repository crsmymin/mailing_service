                                ...
                                <form id="form" name="action" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <hr>
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col col-md-1" style="text-align: center;"><label class=" form-control-label" style="margin: 8px 0;">개소세</label></div>
                                        <div class="col col-md-1" style="text-align: center;"><label class=" form-control-label" style="margin: 8px 0;">ETC</label></div>
                                        <div class="col col-md-2" style="text-align: center;"><label class=" form-control-label" style="margin: 8px 0;">세액합계</label></div>
                                        <div class="col col-md-2" style="text-align: center;"><label class=" form-control-label" style="margin: 8px 0;">청구 금액(30%)</label></div>
                                        <div class="col col-md-2" style="text-align: center;"><label class=" form-control-label" style="margin: 8px 0;">컨설팅 비용(10%)</label></div>
                                        ...
                                        <div class="col col-md-1" style="text-align: center;"><p class="form-control-static" style="margin: 8px 0;">0원</p></div>
                                        <div class="col col-md-1" style="text-align: center;"><p class="form-control-static" style="margin: 8px 0;">0원</p></div>
                                        <div class="col col-md-2" style="text-align: center;"><p class="form-control-static" style="margin: 8px 0;">800,000원</p></div>
                                        <div class="col col-md-2" style="text-align: center;"><p class="form-control-static" style="margin: 8px 0;">240,000원</p></div>
                                    ...
                                    <tbody id="table_list">
										...
										<tr>
											...
											<td class='text-align-center'>1,000,000</td>
											<td class='text-align-center'>100,000</td>
											<td class='text-align-center' data-tooltip-text='환급신청 중 에러!'>대기</td>
										</tr>
										<tr>
											<td class='text-align-center'>1</td>
											<td class='text-align-center'>2020/01/01</td>
